  ...
  return (
    <>
      <div className="container  mx-auto font-sans border-2 border-black">
          ...
          <table className="w-full">
            <tbody className="">
              <tr className="border-b-2 border-black">
                <td className="text-black w-60 border-r-2 border-black p-1 font-bold">
                  Department Name
                </td>
                <td className="text-black w-96 border-r-2 border-black p-1">
                  {department_Name}
                </td>
                <td className="text-black w-60 border-r-2 border-black p-1 font-bold">
                  User Id
              ...
              <tr className="border-b-2 border-black">
                ...
                <td className="text-black w-96 p-1">
              ...
              <tr>
                <td className="text-black border-r-2 border-black p-1 font-bold">
                  Test Status
                </td>
                <td className="text-black border-r-2 border-black p-1">
                  {leakTestStatus}
                </td>
              </tr>
            </tbody>
        ...
        <div className="border-y-4 border-black my-4">
          <div className="font-bold border-b-2 border-black text-black p-1 pl-2">
            Set Parameter (Recipe):
          </div>
          <table className="w-full">
            <tbody>
              <tr className="border-b border-black">
                <td className="text-black w-60 border-r-2 border-b-2 border-black p-1 font-bold">
                  Initial Pressure:
                </td>
                <td className="text-black w-96 border-r-2 border-b-2 border-black p-1">
                  {initial_Pressure} Pa
                </td>
                <td className="text-black w-60 border-r-2 border-b-2 border-black p-1 font-bold">
                  Stabilization Time:
              ...
              <tr>
                ...
                <td className="text-black w-96 border-black p-1">
                ...
                <tr key={rowIndex}>
                  {row.map((value, idx) => (
                    <React.Fragment key={idx}>
                      <td className="text-black p-1 text-center font-bold">
                        {rowIndex * 7 + idx + 1}
                      </td>
